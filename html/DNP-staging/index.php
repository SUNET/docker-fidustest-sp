<?php
if (isset($_GET["eleg"])) {
  header("Location: /Shibboleth.sso/Login?target=https://fidustest.skolverket.se/refeds_mfa/DNP.php&entityID=https://idpproxy.dev.eduid.se/idp&authnContextClassRef=https://refeds.org/profile/mfa");
die();
} elseif (isset($_GET["noeleg"])) {
  header("Location: /Shibboleth.sso/Login?target=https://fidustest.skolverket.se/secure/DNP.php&entityID=https://idpproxy.dev.eduid.se/idp");
  die();
}
...
print_header('Skolverkets testsida för inloggning','../');?>
        ...
        <p><a href="/Shibboleth.sso/Login?target=https://fidustest.skolverket.se/secure/DNP.php&entityID=https://idpproxy.dev.eduid.se/idp"><button class="button">Inloggning utan e-legitimation</button></a></p>
        <p><a href="/Shibboleth.sso/Login?target=https://fidustest.skolverket.se/refeds_mfa/DNP.php&entityID=https://idpproxy.dev.eduid.se/idp&authnContextClassRef=https://refeds.org/profile/mfa"><button class="button">Inloggning med e-legitimation</button></a></p>
