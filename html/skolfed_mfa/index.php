...
#}
if ($_SERVER["Shib-Authentication-Method"] == 'http://id.skolfederation.se/loa/2fa') {
	print '	<h2>Grattis!</h2>' . "\n";
	...
	print '	<p class="largetext">Förväntade oss att <b>Authentication-Method</b> skulle vara <b>http://id.skolfederation.se/loa/2fa</b></p>' . "\n";
}
?>
